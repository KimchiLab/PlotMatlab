function vals = PlotMeanErrText_FromTable(tbl, field_val, field_major, field_minor, colors, field_text, flag_open)
...
% vals = PlotMeanErrText_FromTable(tbl, 'Value', 'Major', 'Minor', [], 'ID', []);
